...
exports.BitStreamWriter = exports.StreamSeekOrigin = void 0;
const Integer53_1 = require("../types/Integer53");
...
})(StreamSeekOrigin = exports.StreamSeekOrigin || (exports.StreamSeekOrigin = {}));
/** MSB first */
class BitStreamWriter {
    ...
    writeBits(v, bitLength) {
        if (0 < bitLength) {
            ...
            let l = bitLength;
            const q = (l % 8) || 8;
            const w = Integer53_1.Integer53.slice(v, l - q, l);
            const s = 8 - m - q;
            this.data[p] &= 0x00ff << (8 - m);
            if (s >= 0) {
                this.data[p] |= w << s;
            ...
            if (m === 0) {
                ...
                for (; 0 < l; l -= 8, p++) {
                    this.data[p] = Integer53_1.Integer53.slice(v, l - 8, l);
                }
            }
            else {
                // tslint:disable-next-line:ban-comma-operator
                for (; 0 < l; l -= 8, p++) {
                    const w2 = Integer53_1.Integer53.slice(v, l - 8, l);
                    this.data[p] &= 0x00ff << (8 - m);
                    this.data[p] |= w2 >>> m;
